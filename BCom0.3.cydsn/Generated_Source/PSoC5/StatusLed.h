...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the StatusLed_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(StatusLed__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in StatusLed_SetInterruptMode() function.
     *  @{
     */
        #define StatusLed_INTR_NONE      (uint16)(0x0000u)
        #define StatusLed_INTR_RISING    (uint16)(0x0001u)
        #define StatusLed_INTR_FALLING   (uint16)(0x0002u)
        #define StatusLed_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define StatusLed_INTR_MASK      (0x01u) 
#endif /* (StatusLed__INTSTAT) */
...
/* SIO registers */
#if defined(StatusLed__SIO_CFG)
    #define StatusLed_SIO_HYST_EN        (* (reg8 *) StatusLed__SIO_HYST_EN)
    #define StatusLed_SIO_REG_HIFREQ     (* (reg8 *) StatusLed__SIO_REG_HIFREQ)
    #define StatusLed_SIO_CFG            (* (reg8 *) StatusLed__SIO_CFG)
    #define StatusLed_SIO_DIFF           (* (reg8 *) StatusLed__SIO_DIFF)
#endif /* (StatusLed__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define StatusLed_0_INTTYPE_REG 		(* (reg8 *) StatusLed__0__INTTYPE)
#endif /* (StatusLed__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_StatusLed_H */
