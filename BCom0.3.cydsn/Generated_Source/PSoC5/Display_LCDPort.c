...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Display_LCDPort_0_INTR) != 0u) 
		{ 
			 Display_LCDPort_0_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Display_LCDPort_1_INTR) != 0u) 
		{ 
			 Display_LCDPort_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Display_LCDPort_2_INTR) != 0u) 
		{ 
			 Display_LCDPort_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Display_LCDPort_3_INTR) != 0u) 
		{ 
			 Display_LCDPort_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Display_LCDPort_4_INTR) != 0u) 
		{ 
			 Display_LCDPort_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Display_LCDPort_5_INTR) != 0u) 
		{ 
			 Display_LCDPort_5_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Display_LCDPort_6_INTR) != 0u) 
		{ 
			 Display_LCDPort_6_INTTYPE_REG = (uint8)mode; 
		}
    }
