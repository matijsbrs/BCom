...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Display_LCDPort_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Display_LCDPort__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Display_LCDPort_SetInterruptMode() function.
     *  @{
     */
        #define Display_LCDPort_INTR_NONE      (uint16)(0x0000u)
        #define Display_LCDPort_INTR_RISING    (uint16)(0x0001u)
        #define Display_LCDPort_INTR_FALLING   (uint16)(0x0002u)
        #define Display_LCDPort_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Display_LCDPort_INTR_MASK      (0x01u) 
#endif /* (Display_LCDPort__INTSTAT) */
...
/* SIO registers */
#if defined(Display_LCDPort__SIO_CFG)
    #define Display_LCDPort_SIO_HYST_EN        (* (reg8 *) Display_LCDPort__SIO_HYST_EN)
    #define Display_LCDPort_SIO_REG_HIFREQ     (* (reg8 *) Display_LCDPort__SIO_REG_HIFREQ)
    #define Display_LCDPort_SIO_CFG            (* (reg8 *) Display_LCDPort__SIO_CFG)
    #define Display_LCDPort_SIO_DIFF           (* (reg8 *) Display_LCDPort__SIO_DIFF)
#endif /* (Display_LCDPort__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Display_LCDPort_0_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__0__INTTYPE)
	#define Display_LCDPort_1_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__1__INTTYPE)
	#define Display_LCDPort_2_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__2__INTTYPE)
	#define Display_LCDPort_3_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__3__INTTYPE)
	#define Display_LCDPort_4_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__4__INTTYPE)
	#define Display_LCDPort_5_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__5__INTTYPE)
	#define Display_LCDPort_6_INTTYPE_REG 		(* (reg8 *) Display_LCDPort__6__INTTYPE)
#endif /* (Display_LCDPort__INTSTAT) */
