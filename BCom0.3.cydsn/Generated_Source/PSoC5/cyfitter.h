...
#define isr_rx__INTC_PRIOR_NUM 1u
...
/* StatusLed */
#define StatusLed__0__INTTYPE CYREG_PICU2_INTTYPE1
#define StatusLed__0__MASK 0x02u
#define StatusLed__0__PC CYREG_PRT2_PC1
#define StatusLed__0__PORT 2u
#define StatusLed__0__SHIFT 1u
#define StatusLed__AG CYREG_PRT2_AG
#define StatusLed__AMUX CYREG_PRT2_AMUX
#define StatusLed__BIE CYREG_PRT2_BIE
#define StatusLed__BIT_MASK CYREG_PRT2_BIT_MASK
#define StatusLed__BYP CYREG_PRT2_BYP
#define StatusLed__CTL CYREG_PRT2_CTL
#define StatusLed__DM0 CYREG_PRT2_DM0
#define StatusLed__DM1 CYREG_PRT2_DM1
#define StatusLed__DM2 CYREG_PRT2_DM2
#define StatusLed__DR CYREG_PRT2_DR
#define StatusLed__INP_DIS CYREG_PRT2_INP_DIS
#define StatusLed__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define StatusLed__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define StatusLed__LCD_EN CYREG_PRT2_LCD_EN
#define StatusLed__MASK 0x02u
#define StatusLed__PORT 2u
#define StatusLed__PRT CYREG_PRT2_PRT
#define StatusLed__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define StatusLed__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define StatusLed__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define StatusLed__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define StatusLed__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define StatusLed__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define StatusLed__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define StatusLed__PS CYREG_PRT2_PS
#define StatusLed__SHIFT 1u
#define StatusLed__SLW CYREG_PRT2_SLW

/* StripLights */
#define StripLights_B_WS2811_ctrl__0__MASK 0x01u
#define StripLights_B_WS2811_ctrl__0__POS 0
#define StripLights_B_WS2811_ctrl__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB08_09_ACTL
#define StripLights_B_WS2811_ctrl__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB08_09_CTL
#define StripLights_B_WS2811_ctrl__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB08_09_CTL
#define StripLights_B_WS2811_ctrl__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB08_09_CTL
#define StripLights_B_WS2811_ctrl__16BIT_COUNT_COUNT_REG CYREG_B0_UDB08_09_CTL
#define StripLights_B_WS2811_ctrl__16BIT_MASK_MASK_REG CYREG_B0_UDB08_09_MSK
#define StripLights_B_WS2811_ctrl__16BIT_MASK_PERIOD_REG CYREG_B0_UDB08_09_MSK
#define StripLights_B_WS2811_ctrl__16BIT_PERIOD_MASK_REG CYREG_B0_UDB08_09_MSK
#define StripLights_B_WS2811_ctrl__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB08_09_MSK
...
#define StripLights_B_WS2811_ctrl__CONTROL_AUX_CTL_REG CYREG_B0_UDB08_ACTL
#define StripLights_B_WS2811_ctrl__CONTROL_REG CYREG_B0_UDB08_CTL
#define StripLights_B_WS2811_ctrl__CONTROL_ST_REG CYREG_B0_UDB08_ST_CTL
#define StripLights_B_WS2811_ctrl__COUNT_REG CYREG_B0_UDB08_CTL
#define StripLights_B_WS2811_ctrl__COUNT_ST_REG CYREG_B0_UDB08_ST_CTL
#define StripLights_B_WS2811_ctrl__MASK 0x39u
#define StripLights_B_WS2811_ctrl__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB08_MSK_ACTL
#define StripLights_B_WS2811_ctrl__PER_CTL_AUX_CTL_REG CYREG_B0_UDB08_MSK_ACTL
#define StripLights_B_WS2811_ctrl__PERIOD_REG CYREG_B0_UDB08_MSK
#define StripLights_B_WS2811_dshifter_u0__16BIT_A0_REG CYREG_B1_UDB08_09_A0
#define StripLights_B_WS2811_dshifter_u0__16BIT_A1_REG CYREG_B1_UDB08_09_A1
#define StripLights_B_WS2811_dshifter_u0__16BIT_D0_REG CYREG_B1_UDB08_09_D0
#define StripLights_B_WS2811_dshifter_u0__16BIT_D1_REG CYREG_B1_UDB08_09_D1
#define StripLights_B_WS2811_dshifter_u0__16BIT_DP_AUX_CTL_REG CYREG_B1_UDB08_09_ACTL
#define StripLights_B_WS2811_dshifter_u0__16BIT_F0_REG CYREG_B1_UDB08_09_F0
#define StripLights_B_WS2811_dshifter_u0__16BIT_F1_REG CYREG_B1_UDB08_09_F1
#define StripLights_B_WS2811_dshifter_u0__A0_A1_REG CYREG_B1_UDB08_A0_A1
#define StripLights_B_WS2811_dshifter_u0__A0_REG CYREG_B1_UDB08_A0
#define StripLights_B_WS2811_dshifter_u0__A1_REG CYREG_B1_UDB08_A1
#define StripLights_B_WS2811_dshifter_u0__D0_D1_REG CYREG_B1_UDB08_D0_D1
#define StripLights_B_WS2811_dshifter_u0__D0_REG CYREG_B1_UDB08_D0
#define StripLights_B_WS2811_dshifter_u0__D1_REG CYREG_B1_UDB08_D1
#define StripLights_B_WS2811_dshifter_u0__DP_AUX_CTL_REG CYREG_B1_UDB08_ACTL
#define StripLights_B_WS2811_dshifter_u0__F0_F1_REG CYREG_B1_UDB08_F0_F1
#define StripLights_B_WS2811_dshifter_u0__F0_REG CYREG_B1_UDB08_F0
#define StripLights_B_WS2811_dshifter_u0__F1_REG CYREG_B1_UDB08_F1
#define StripLights_B_WS2811_dshifter_u0__MSK_DP_AUX_CTL_REG CYREG_B1_UDB08_MSK_ACTL
#define StripLights_B_WS2811_dshifter_u0__PER_DP_AUX_CTL_REG CYREG_B1_UDB08_MSK_ACTL
#define StripLights_B_WS2811_pwm8_u0__A0_A1_REG CYREG_B1_UDB11_A0_A1
#define StripLights_B_WS2811_pwm8_u0__A0_REG CYREG_B1_UDB11_A0
#define StripLights_B_WS2811_pwm8_u0__A1_REG CYREG_B1_UDB11_A1
#define StripLights_B_WS2811_pwm8_u0__D0_D1_REG CYREG_B1_UDB11_D0_D1
#define StripLights_B_WS2811_pwm8_u0__D0_REG CYREG_B1_UDB11_D0
#define StripLights_B_WS2811_pwm8_u0__D1_REG CYREG_B1_UDB11_D1
#define StripLights_B_WS2811_pwm8_u0__DP_AUX_CTL_REG CYREG_B1_UDB11_ACTL
#define StripLights_B_WS2811_pwm8_u0__F0_F1_REG CYREG_B1_UDB11_F0_F1
#define StripLights_B_WS2811_pwm8_u0__F0_REG CYREG_B1_UDB11_F0
#define StripLights_B_WS2811_pwm8_u0__F1_REG CYREG_B1_UDB11_F1
...
#define StripLights_B_WS2811_StatusReg__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB11_12_ACTL
#define StripLights_B_WS2811_StatusReg__16BIT_STATUS_REG CYREG_B0_UDB11_12_ST
...
#define StripLights_B_WS2811_StatusReg__MASK_REG CYREG_B0_UDB11_MSK
#define StripLights_B_WS2811_StatusReg__MASK_ST_AUX_CTL_REG CYREG_B0_UDB11_MSK_ACTL
#define StripLights_B_WS2811_StatusReg__PER_ST_AUX_CTL_REG CYREG_B0_UDB11_MSK_ACTL
#define StripLights_B_WS2811_StatusReg__STATUS_AUX_CTL_REG CYREG_B0_UDB11_ACTL
#define StripLights_B_WS2811_StatusReg__STATUS_CNT_REG CYREG_B0_UDB11_ST_CTL
#define StripLights_B_WS2811_StatusReg__STATUS_CONTROL_REG CYREG_B0_UDB11_ST_CTL
#define StripLights_B_WS2811_StatusReg__STATUS_REG CYREG_B0_UDB11_ST
#define StripLights_cisr__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define StripLights_cisr__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define StripLights_cisr__INTC_MASK 0x01u
#define StripLights_cisr__INTC_NUMBER 0u
#define StripLights_cisr__INTC_PRIOR_NUM 7u
#define StripLights_cisr__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define StripLights_cisr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define StripLights_cisr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
#define StripLights_Clock__CFG0 CYREG_CLKDIST_DCFG0_CFG0
#define StripLights_Clock__CFG1 CYREG_CLKDIST_DCFG0_CFG1
#define StripLights_Clock__CFG2 CYREG_CLKDIST_DCFG0_CFG2
#define StripLights_Clock__CFG2_SRC_SEL_MASK 0x07u
#define StripLights_Clock__INDEX 0x00u
#define StripLights_Clock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define StripLights_Clock__PM_ACT_MSK 0x01u
#define StripLights_Clock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define StripLights_Clock__PM_STBY_MSK 0x01u
#define StripLights_fisr__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define StripLights_fisr__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define StripLights_fisr__INTC_MASK 0x02u
#define StripLights_fisr__INTC_NUMBER 1u
#define StripLights_fisr__INTC_PRIOR_NUM 7u
#define StripLights_fisr__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define StripLights_fisr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define StripLights_fisr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB11_12_ACTL
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB11_12_CTL
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB11_12_CTL
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB11_12_CTL
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB11_12_CTL
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B0_UDB11_12_MSK
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB11_12_MSK
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB11_12_MSK
#define StripLights_StringSel_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB11_12_MSK
...
#define StripLights_StringSel_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B0_UDB11_ACTL
#define StripLights_StringSel_Sync_ctrl_reg__CONTROL_REG CYREG_B0_UDB11_CTL
#define StripLights_StringSel_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B0_UDB11_ST_CTL
#define StripLights_StringSel_Sync_ctrl_reg__COUNT_REG CYREG_B0_UDB11_CTL
#define StripLights_StringSel_Sync_ctrl_reg__COUNT_ST_REG CYREG_B0_UDB11_ST_CTL
#define StripLights_StringSel_Sync_ctrl_reg__MASK 0x0Fu
#define StripLights_StringSel_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB11_MSK_ACTL
#define StripLights_StringSel_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB11_MSK_ACTL
#define StripLights_StringSel_Sync_ctrl_reg__PERIOD_REG CYREG_B0_UDB11_MSK

/* LedDriverOut */
#define LedDriverOut__0__INTTYPE CYREG_PICU15_INTTYPE0
#define LedDriverOut__0__MASK 0x01u
#define LedDriverOut__0__PC CYREG_IO_PC_PRT15_PC0
#define LedDriverOut__0__PORT 15u
#define LedDriverOut__0__SHIFT 0u
#define LedDriverOut__AG CYREG_PRT15_AG
#define LedDriverOut__AMUX CYREG_PRT15_AMUX
#define LedDriverOut__BIE CYREG_PRT15_BIE
#define LedDriverOut__BIT_MASK CYREG_PRT15_BIT_MASK
#define LedDriverOut__BYP CYREG_PRT15_BYP
#define LedDriverOut__CTL CYREG_PRT15_CTL
#define LedDriverOut__DM0 CYREG_PRT15_DM0
#define LedDriverOut__DM1 CYREG_PRT15_DM1
#define LedDriverOut__DM2 CYREG_PRT15_DM2
#define LedDriverOut__DR CYREG_PRT15_DR
#define LedDriverOut__INP_DIS CYREG_PRT15_INP_DIS
#define LedDriverOut__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU15_BASE
#define LedDriverOut__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define LedDriverOut__LCD_EN CYREG_PRT15_LCD_EN
#define LedDriverOut__MASK 0x01u
#define LedDriverOut__PORT 15u
#define LedDriverOut__PRT CYREG_PRT15_PRT
#define LedDriverOut__PRTDSI__CAPS_SEL CYREG_PRT15_CAPS_SEL
#define LedDriverOut__PRTDSI__DBL_SYNC_IN CYREG_PRT15_DBL_SYNC_IN
#define LedDriverOut__PRTDSI__OE_SEL0 CYREG_PRT15_OE_SEL0
#define LedDriverOut__PRTDSI__OE_SEL1 CYREG_PRT15_OE_SEL1
#define LedDriverOut__PRTDSI__OUT_SEL0 CYREG_PRT15_OUT_SEL0
#define LedDriverOut__PRTDSI__OUT_SEL1 CYREG_PRT15_OUT_SEL1
#define LedDriverOut__PRTDSI__SYNC_OUT CYREG_PRT15_SYNC_OUT
#define LedDriverOut__PS CYREG_PRT15_PS
#define LedDriverOut__SHIFT 0u
#define LedDriverOut__SLW CYREG_PRT15_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "BCom0.3"
